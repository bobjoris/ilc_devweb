 ...
 * Address
 *
 * @ORM\Table(name="ilc_addresses")
 * @ORM\Entity(repositoryClass="Ilc\Bundle\ShopBundle\Entity\AddressRepository")
 */
class Address
{
    /**
    ...
    /**
     * @ORM\ManyToONe(targetEntity="Client", inversedBy="addresses", cascade={"remove"})
